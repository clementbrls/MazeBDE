...
public class MathsPro {
    ...
    /**
     * Returns a random double number between 0 and 1, using the U-shape density function.
     *
     * @return A random double number between 0 and 1, using the U-shape density function.
     */
    ...
    /**
     * Returns a random float number between 0 and max, using the U-shape density function.
     *
     * @param max The maximum value of the range.
     * @return A random float number between 0 and max, using the U-shape density function.
     */
    ...
    /**
     * Returns a random integer between 0 and max, using the U-shape density function.
     *
     * @param max The maximum value of the range.
     * @return A random integer between 0 and max, using the U-shape density function.
     */
